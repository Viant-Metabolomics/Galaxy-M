function BlankFilter(pls_dso_file, thresh_perc, maxmean, thresh_fold, del, outfile)
%
...
if isa(thresh_perc, 'char')
	thresh_perc = str2num(thresh_perc);
end

if isa(maxmean, 'char')
	maxmean = str2num(maxmean);
end

if isa(thresh_fold, 'char')
	thresh_fold = str2num(thresh_fold);
end
